...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 11 11:53:19 2020
...
class DesiredTrajectories: 
    ...
    def SCP0(self):
        ...
        for i in range(10):
            ...
            for k in range(N):
                ...
                constraints += [-self.SafetyConstraint(Xk,Xs_k) <= p2[k]]
    ...
    def SCP(self):
        ...
        for i in range(20):
            ...
            for k in range(N):
                ...
                Us_k = Uhis[k,:]
                constraints += [cp.norm(Xk-Xs_k) <= Tregion]
                constraints += [-self.SafetyConstraint(Xk,Xs_k) <= 0]
                constraints += [Xkp1 == self.DynamicsLD(dt,Xk,Uk,Xs_k,Us_k)]
    ...
    def SafetyConstraint(self,Xk,Xs_k):
        Xobs = self.Xobs
