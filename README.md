...
* Start from smaller value of alpha (contraction rate) : Since the stability constraint becomes tighter as alpha becomes larger, set alims[0] (minimum alpha) smaller.
